...
interface IfcContainerProps {
  viewer: IfcViewerAPI | null; // Change this line
}
      ...
      if (viewer) {
        ...
        if (result) {
          ...
          if (props) {
            ...
            ifcRecords["Entity Type"] = await type;
            ifcRecords["GlobalId"] = props.GlobalId?.value ?? "";
            ifcRecords["Name"] = props.Name?.value ?? "";
            ifcRecords["ObjectType"] = props.ObjectType?.value ?? "";
    ...
    return (
      <>
        <div
          ...
          onMouseMove={
            viewer ? () => viewer.IFC.selector.prePickIfcItem() : undefined
          }
          style={{
            position: "relative",
            width: "100vw",
